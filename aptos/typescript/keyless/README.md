...
3. In your .env.local file, uncomment and set the value for GAS_STATION_TESTNET_ACCESS_KEY: your Shinami API access key with rights to Testnet Gas Station (which you create in your Shinami dashboard: https://app.shinami.com/access-keys)
