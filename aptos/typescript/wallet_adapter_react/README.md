...
3. In your .env.local file, uncomment and set the value for ALL_SERVICES_TESTNET_ACCESS_KEY: your Shinami API access key with rights to Wallet Services and Testnet Gas Station (which you create in your Shinami dashboard: https://app.shinami.com/access-keys)
