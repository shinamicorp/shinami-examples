...
- [Backend-only examples](https://github.com/shinamicorp/shinami-examples/tree/main/movement/typescript/backend_examples) for using Shinami's Gas Station for transaction gas fee sponsorship. Uses the [`@aptos-labs/ts-sdk`](https://www.npmjs.com/package/@aptos-labs/ts-sdk) and [`@shinami/clients`](https://www.npmjs.com/package/@shinami/clients) TypeScript SDKs.
