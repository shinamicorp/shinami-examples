...
7. BE or FE: execute the transaction using a Sui Node Service.
...
3. In your .env.local file, uncomment and set values for GAS_AND_WALLET_TESTNET_ACCESS_KEY, as well as a USER123_WALLET_ID and USER123_WALLET_SECRET for creating a Shinami Invisible Wallet. You must set these and, only for the purposes of this simple test, can use something like 'wallet1' and 'secret1'. Save the change.
